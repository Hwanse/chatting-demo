...
public class ChatRoomDocumentation {
    ...
    public static RestDocumentationResultHandler getChatRoomApiDocument() {
        return document("chatroom/info", me.hwanse.chatserver.config.ApiDocumentUtil.getDocumentRequest(),
                        pathParameters(
    ...
    public static RestDocumentationResultHandler disableChatRoomApiDocument() {
        return document("chatroom/disable", me.hwanse.chatserver.config.ApiDocumentUtil.getDocumentRequest(),
                        pathParameters(
