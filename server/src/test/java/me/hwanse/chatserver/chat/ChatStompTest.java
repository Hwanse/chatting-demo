...
/**
 * 테스트 코드 종료 시점에 Table 스키마가 전부 Drop 되는데 그 이후에 SessionDisconnect 이벤트가 발생하여
 * 프로젝트 build 과정 중 test task 에서 SQL Exception이 발생하여 Disabled 설정
 * TODO 위 오류에 대한 테스트 환경 개선 필요
 */
@Disabled
